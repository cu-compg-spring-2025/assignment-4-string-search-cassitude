...
def get_args():
    ...
    parser.add_argument("--pattern_size", type=int, required=True, help="Pattern size")
    parser.add_argument(
        "--rounds",
        type=int,
        default=10,
    ...
    parser.add_argument(
        "--out_file", type=str, required=True, help="File to save plot to"
    )
    parser.add_argument(
        "--width", type=float, default=8, help="Width of plot in inches (default: 8)"
    )
    parser.add_argument(
        "--height", type=float, default=5, help="Height of plot in inches (default: 5)"
    )
...
def main():
    ...
    run_times, mem_usages = test_harness(
        test_functions, text_size_range, args.pattern_size, args.rounds
    )
